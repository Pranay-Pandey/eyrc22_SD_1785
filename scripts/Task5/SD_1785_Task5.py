...
class DroneController:
    def __init__(self):
        ...
        self.csv_loc = r'/home/aniket/images/data.csv'
    ...
    def gdal(self):
        ...
        dest= '/home/aniket/images/updated_task2d.tif'
    ...
    #                 self.err_x = X*0.001
    #                 self.err_y = Y*0.001
    #                 if(m.sqrt(X*X + Y*Y)<self.thres):
    #                     cv2.imwrite(f'/home/aniket/images/aniketaagya{self.count}.png',self.img)
    ...
    def g_ref_info(self, img1):
        print("yaha226")
        src = "/home/aniket/images/aniketaagya.png"
        ker = np.array([[0,-1,0],
                        [-1,5,-1],
                        [0,-1,0]])
        sharp_img = cv2.filter2D(src=img1,ddepth=-1,kernel=ker)
        cv2.imwrite(src,sharp_img)

        img2 = cv2.imread('/home/aniket/images/task2d.tif')
        ...
        ds = gdal.Open('/home/aniket/images/task2d.tif')
        ...
        src='/home/aniket/images/updated_task2d.tif'
        
        dest= '/home/aniket/images/fupdated_task2d.tif'
    ...
    def Image_processing(self, img):
        ...
        if cont:
            ...
            if cv2.contourArea(cnt) >= 100:
                ...
                # h,w = img.shape[:2]
                print(count)
                if(flag1==0 and count>=80):
                    print("it has started")
                    self.g_ref_info(img)
                    flag1=1
                    ds = gdal.Open('/home/aniket/images/fupdated_task2d.tif')
                    xoff, a, b, yoff, d, e = ds.GetGeoTransform()
                    (x,y) = self.pixel2coord( cX,cY , a , b, xoff, d , e, yoff)
                    self.mssssg.objectid = str(1)
                    ...
                    writer.writerow([str(1), np.float32(x), np.float32(y)])
                    rospy.loginfo("FINAL_OUTPUT  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
                    print("FINAL_OUTPUT  "+str(1) +" "+ str(x) +" "+ str(y) )
                    file_csv.close()
                    self.Landing=True
